<!DOCTYPE html><html lang="en"><head> <meta charset="UTF-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <link rel="preconnect" href="https://fonts.googleapis.com"> <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin> 
<link href="https://i.ibb.co/6BKfMk5/android-chrome-192x192.png" rel="icon" type="image/x-icon">
<link rel="stylesheet"
<link href="https://fonts.googleapis.com/css2?family=Bree+Serif&family=Montserrat:wght@400;600&display=swap" rel="stylesheet"> <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"> <link rel="stylesheet" href="style.css"> <title>Number Details Finder</title>  </head><style> select { width: 100%; height: 65px; margin: 15px 0; border-radius: 4px;		padding:0 20px;		font-size: 15px;		outline: none; font-family: 'Bree Serif', serif; }</style><body> <div class="limiter"> <h1>Number Details Finder</h1><?php
...
$headers6=['Host: search5-noneu.truecaller.com','authorization: Bearer a2i0j--jwsozVFfFDwnPVJPsTjpJnLGpivGR8JM4TM3wzyOkEIt-l1Fnl74x4kfD ', 'user-agent: Truecaller/13.1.7 (Android;9'];
...
<div class='white'><font colour='black'> Searched Number Details :-  </div><br></font>
<img src= $image id='image' class='rotate' height='150'></image>
...
<div class='white'><font colour='black'>Total Number Searched : <font colour='blue'> <?php echo"$s1"; ?> </div></font><br></body> </html>